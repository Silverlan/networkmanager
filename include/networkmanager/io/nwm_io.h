...
class NWMIO
	: public NWMErrorHandle,public NWMIOHeader,public NWMIOBase
{
protected:
	struct PacketQueueItem
	{
		PacketQueueItem(const NetPacket &p,const NWMEndpoint &ep,bool bOwn)
			: packet(p),own(bOwn),endPoint(ep)
		{}
		NetPacket packet;
		DataStream header;
