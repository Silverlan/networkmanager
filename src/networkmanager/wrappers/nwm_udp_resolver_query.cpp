...
nwm::UDPResolverQuery::UDPResolverQuery(const std::string &ip,const std::string &port)
	: m_resolverQuery{impl::unique_void<boost::asio::ip::udp::resolver::query>(new boost::asio::ip::udp::resolver::query{ip,port})}
{}
