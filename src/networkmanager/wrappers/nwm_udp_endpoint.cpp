...
nwm::UDPEndpoint::UDPEndpoint(const UDPEndpoint &ep)
	: m_endPoint{impl::unique_void<boost::asio::ip::udp::endpoint>(new boost::asio::ip::udp::endpoint{*static_cast<const boost::asio::ip::udp::endpoint*>(ep.GetBoostObject())})}
{}
nwm::UDPEndpoint::UDPEndpoint(void *boostUDPEndpoint)
	: m_endPoint{impl::unique_void<boost::asio::ip::udp::endpoint>(new boost::asio::ip::udp::endpoint{*static_cast<boost::asio::ip::udp::endpoint*>(boostUDPEndpoint)})}
{}
nwm::UDPEndpoint::UDPEndpoint()
	: m_endPoint{impl::unique_void<boost::asio::ip::udp::endpoint>(new boost::asio::ip::udp::endpoint{})}
{}
